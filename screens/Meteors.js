...
export default class MeteorScreen extends Component {
    ...
    getMeteors=()=>{
    axios.get("https://api.nasa.gov/neo/rest/v1/feed?api_key=Nh7sTSQG2NuAeCP26e7uZ9IgPD1XAEDXgiApmzcV")
    .then(response=>{
...
<View>
<ImageBackground
soure={bgimg} style={{flex:1, resizeMode:'cover', width:Dimensions.get("window").width,height:Dimensions.get("window").height}} 
>
